# CLAUDE.md - Project Guidelines for clocked
...
**Tier 3+ (Comprehensive and above)**:

- [ ] E2E tests pass (for JS stacks)
- [ ] Load tests pass (for Python stacks)
...
- [ ] Bundle size within limits (JS stacks)
- [ ] API documentation complete (Python stacks)
